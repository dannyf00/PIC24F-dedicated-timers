...
//for U1ART
#define UxMD				PMD1bits.U1MD		//power management bit
#define UxMODE				U1MODEbits	//mode register
#define UxBRG				U1BRG		//baud rate generator
#define UxSTA				U1STAbits	//status register
#define UxTXIE				IEC0bits.U1TXIE		//interrupt enable bit
#define UxTXIF				IFS0bits.U1TXIF		//interrupt flag
#define UxRXIE				IEC0bits.U1RXIE		//interrupt enable bit
#define UxRXIF				IFS0bits.U1RXIF		//interrupt flag
